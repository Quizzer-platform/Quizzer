<template>
    ...
    <div class="flex items-center justify-center min-h-screen bg-gray-100 dark:bg-[#151a24] p-4">
        <div class="flex flex-col-reverse md:flex-row w-full max-w-5xl bg-white dark:bg-gray-800 rounded-lg shadow-lg overflow-hidden">
...
.dark input:-webkit-autofill {
  background-color: transparent !important;
  -webkit-box-shadow: 0 0 0px 1000px #374151 inset !important; /* Matches dark:bg-gray-700 */
