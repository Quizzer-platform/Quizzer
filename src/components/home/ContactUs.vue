            ...
            <div class="flex flex-wrap lg:justify-between">
                <div class="w-full px-4 lg:w-1/2 xl:w-6/12">
                    <div class="mb-12 max-w-[570px] lg:mb-0">
                        ...
                        <p class="text-base leading-relaxed text-gray-600 dark:text-gray-300 mb-9">
                        ...
                        <div class="mb-8 flex w-full max-w-[370px]">
                            ...
                            <div class="w-full">
                                <h4 class="mb-1 text-xl font-bold text-gray-900 dark:text-white">Phone Number</h4>
                                <p class="text-base text-gray-600 dark:text-gray-300">(+2) 01 123 456 789</p>
                            </div>
                        </div>
                        <div class="mb-8 flex w-full max-w-[370px]">
                            <div
                            ...
                            <div class="w-full">
                                <h4 class="mb-1 text-xl font-bold text-gray-900 dark:text-white">Email Address</h4>
                                <p class="text-base text-gray-600 dark:text-gray-300">info@Quizzer.com</p>
                            </div>
                        </div>
                    </div>
                </div>
