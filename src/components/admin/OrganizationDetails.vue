                ...
                <div v-else class="bg-white p-6 rounded-lg shadow-lg border border-gray-200 mt-6 w-full">
                    <div class="flex flex-col md:flex-row md:justify-between md:items-center space-y-6 md:space-y-0">
                        ...
                        <div class="md:w-3/4">
                            ...
                            <p class="text-gray-600"><strong>Admin Email:</strong> {{ selectedOrg.adminEmail || 'N/A' }}
                            </p>
                            <p class="text-gray-600"><strong>Admin Phone:</strong> {{ selectedOrg.adminPhone || 'N/A' }}
                            </p>
                        </div>

                        <!-- Total Quizzes Card -->
                        <div
                            class="bg-gray-100 p-6 rounded-lg shadow-md w-full md:w-1/4 text-center border border-gray-200">
                            <div class="flex flex-col items-center">
                                <svg class="h-14 w-14 text-teal-600 mb-3" fill="none" stroke="currentColor"
                    ...
                    <div class="mt-8 w-full">
                        ...
                        <div v-if="selectedOrg.plans && Object.values(selectedOrg.plans).length > 1"
                            ...
                            <div v-for="(plan, index) in Object.values(selectedOrg.plans).slice(1)" :key="index"
                                ...
                                <p class="text-gray-600">Quizzes Allowed: {{ plan.noOfQuizzes - selectedOrg.quizzes }}
                                </p>
                            </div>
                        </div>

                        <!-- No Additional Plans Message -->
                        <p v-else class="text-gray-500 text-center mt-4">This organization has no additional plans yet.
                        </p>
                    </div>
