        ...
        <div class="flex flex-col md:flex-row w-full max-w-4xl bg-white rounded-lg shadow-lg overflow-hidden">
            <div class="w-full md:w-1/2 p-6 md:p-10">
                ...
                <form @submit.prevent="handleOrgSignup">
                    <div class="mb-4">
                        <label for="orgName" class="block text-gray-700">Organization Name</label>
                    ...
                    <div class="mb-4">
                        <label for="orgEmail" class="block text-gray-700">Admin Email</label>
                        <input id="orgEmail" v-model="org.email" type="email" placeholder="Enter admin email"
                            class="w-full p-2 border rounded-lg mt-1">
                        <p v-if="errors.email" class="text-red-500 text-sm">{{ errors.email }}</p>
                    </div>
                    <div class="mb-4">
                        <label for="orgPass" class="block text-gray-700">Admin Password</label>
                        <input id="orgPass" v-model="org.password" type="password" placeholder="Enter admin password"
                            class="w-full p-2 border rounded-lg mt-1">
                        <p v-if="errors.password" class="text-red-500 text-sm">{{ errors.password }}</p>
                    </div>
                    <div class="mb-4">
                        <label for="orgPhone" class="block text-gray-700">Admin Phone</label>
