            ...
            <div class="w-full md:w-1/2 p-6 md:p-10">
                ...
                <form @submit.prevent="handleSignup">
                    ...
                    <div class="mb-4">
                        ...
                        <input v-model="user.phone" type="text" placeholder="Enter your phone number" 
                            class="w-full p-2 border rounded-lg">
                        <p v-if="errors.phone" class="text-red-500 text-sm">{{ errors.phone }}</p>
                    </div>
                    <div class="mb-4">
                        <label class="block text-gray-700">Organization (Optional)</label>
                    ...
                    <p class="text-center mt-4 text-gray-600">
                        <router-link to="/organizationsignup" class="text-teal-600">Signup your organization </router-link>
                    </p>
                </form>
            </div>
