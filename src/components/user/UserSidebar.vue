<template>
    <div>
        ...
        <button @click="toggleSidebar"
            class="md:hidden p-4 bg-teal-900 text-white flex justify-start w-full dark:bg-gray-800">
            ☰
        </button>

        <!-- Sidebar -->
        <aside class="fixed left-0 top-0 h-screen w-64 bg-teal-900 text-white flex flex-col transition-transform duration-300 
            ...
            <div class="relative flex items-center justify-between p-4">
                ...
                <button @click="toggleDarkMode"
                    ...
                    <!-- Sun Icon (Light Mode) -->
                    <svg v-else class="absolute right-1 w-4 h-4 text-yellow-500 transition-all duration-300" fill="none"
