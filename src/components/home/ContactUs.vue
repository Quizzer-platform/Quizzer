    <template>
        <section class="relative z-10 overflow-hidden bg-white dark:bg-dark py-10 lg:py-[60px] ">
        <div class="container lg:mx-45 md:mx-30">
            ...
            <div class="w-full px-4 lg:w-1/2 xl:w-6/12">
                ...
                <div class=" flex w-full max-w-[370px]">
                    <div
