...
<Navbar class="fixed top-0 left-0 w-full h-20 bg-white dark:bg-gray-900 shadow z-10"></Navbar>
    ...
    <div class="container mx-auto px-4 sm:px-6 flex items-center justify-center mt-5">
        <div class="max-w-4xl mx-auto w-full text-center py-8 sm:py-12">
            ...
            <h1 class="md:text-4xl text-2xl font-bold text-gray-900 dark:text-white mt-6 sm:mt-8">
                The <span class="bg-teal-200 dark:bg-teal-700 dark:text-white px-3 py-2 rounded-lg">Ultimate</span> Quiz Platform
            ...
            <div class="mt-4 text-md text-teal-600 dark:text-teal-400 font-semibold italic">
                <span class="block">Join thousands of organizations and candidates who rely on Quizzer</span>
                <span class="block mt-1">to measure skills and make smarter hiring decisions.</span>
            </div>
    ...
    <div class="max-w-4xl mx-auto mt-2">
        ...
        <div class="text-gray-600 dark:text-gray-300 my-4 max-w-xl mx-auto">
            <p>Our platform connects job seekers to jobs based on their quiz results, helping employers find the right talent and candidates prove their skills.</p>
        </div>

        <!-- Features Grid -->
        <div class="mt-8 grid grid-cols-1 md:grid-cols-3 gap-8">
            <!-- Card 1 -->
            <div class="relative bg-gray-100 dark:bg-gray-800 p-6 rounded-lg shadow-lg dark:shadow-lg transition-all duration-300 hover:-translate-y-2 hover:shadow-lg dark:hover:shadow-[0_8px_20px_rgba(0,255,255,0.3)]">
                ...
                <div class="absolute inset-0 bg-gradient-to-br from-teal-300 to-teal-500 opacity-0 hover:opacity-20 transition-opacity duration-300 rounded-lg"></div>
            </div>
    ...
    <div class="mx-auto">
      ...
      <button @click="$router.push('/categories')"
        class="mt-8 border border-gray-300 dark:border-gray-600 px-8 py-3 rounded-lg cursor-pointer 
    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="mt-8 grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="relative bg-gray-100 dark:bg-gray-800 p-6 rounded-lg shadow-lg dark:shadow-lg transition-all duration-300 hover:-translate-y-2 hover:shadow-lg dark:hover:shadow-[0_8px_20px_rgba(0,255,255,0.3)]">
                ...
                <p class="mt-4 text-gray-700 dark:text-gray-300 italic">
                    "As an HR manager, I love how Quizzer simplifies hiring. The skill-based assessments are spot-on!"
                </p>
                <div class="absolute inset-0 bg-gradient-to-br from-teal-300 to-teal-500 opacity-0 hover:opacity-20 transition-opacity duration-300 rounded-lg"></div>
            </div>
