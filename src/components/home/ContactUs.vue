<template>
    <section class="relative z-10 overflow-hidden bg-white py-10 lg:py-[60px]">
        <div class="container mx-auto px-4 lg:px-8">
            <div class="flex flex-wrap lg:justify-between">
                <div class="w-full px-4 lg:w-1/2 xl:w-6/12">
                    <div class="mb-12 max-w-[570px] lg:mb-0">
                        <span class="block mb-4 text-3xl font-semibold text-teal-700">Contact Us</span>
                        <h2 class="mb-6 text-3xl font-bold text-gray-900 uppercase">
                            GET IN TOUCH WITH US
                        </h2>
                        <p class="text-base leading-relaxed text-gray-600 mb-9">
                        ...
                        <div class="flex w-full max-w-[370px] mb-8">
                            <div
                                class="bg-teal-50 text-teal-700 mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded sm:h-[70px] sm:max-w-[70px]">
                            ...
                            <div class="w-full">
                                <h4 class="mb-1 text-xl font-bold text-gray-900">Our Location</h4>
                                <p class="text-base text-gray-600">
                                    99 S.t Jomblo Park Pekanbaru 28292. Egypt
                                </p>
                            </div>
                        </div>
                        <div class="mb-8 flex w-full max-w-[370px]">
                            ...
                            <div class="w-full">
                                ...
                                <p class="text-base text-body-color dark:text-dark-6">(+2) 01 123 456 789</p>
                            </div>
                        </div>
                        <div class="mb-8 flex w-full max-w-[370px]">
                            <div
                            ...
                            <div class="w-full">
                                ...
                                <p class="text-base text-body-color dark:text-dark-6">info@Quizzer.com</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="w-full lg:w-1/2 xl:w-5/12 lg:me-25 ">
                    <div class="relative p-8 bg-white rounded-lg shadow-lg sm:p-12">
                        <form @submit.prevent="sendEmail">
                            ...
                            <div class="mb-6">
                                <input v-model="phone" type="text" placeholder="Your Phone"
                                    class="border-stroke dark:border-dark-3 dark:text-dark-6 dark:bg-dark text-body-color focus:border-primary w-full rounded border py-3 px-[14px] text-base outline-none" />
                            </div>
                            <div class="mb-6">
